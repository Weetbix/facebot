...
Facebot.prototype.setupFacebook = function(){
    ...
    .then(function(data){
        self.sendDebugMessage("Loaded data, found " + data.channelLinks.length + " channel links.");
    ...
    .fail(function(err){
        self.sendDebugMessage("Couldn't log in with any saved data, logging in with email and pass ("+err+").");
...
Facebot.prototype.createFBApi = function(credentials){
    ...
    return Q.nfcall(facebook, credentials)
           .then(function(api){
                self.sendDebugMessage("Logged into facebook")
